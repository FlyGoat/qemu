 ...
 */
#define ASE_TX79_MMI      0x0100000000000000ULL
#define ASE_INGENIC_MXU   0x0200000000000000ULL
...
#define CPU_LOONGSON3A  (CPU_MIPS64R2 | ASE_LOONGSON_MMI | ASE_LOONGSON_EXT)
